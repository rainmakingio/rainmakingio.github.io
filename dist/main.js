...
jQuery(document).ready(function() {
	...
	$(document).delegate('a[href^="/"],a[href^="'+siteUrl+'"]', "click", function(e) {
		e.preventDefault();
		if( $(this).hasClass('minipage') ) {
			console.log('this is minipage')
			History.pushState({}, "minipage", this.pathname);
		} else {
			console.log('this is page')
			History.pushState({}, "page", this.pathname);
		}
	});

	History.Adapter.bind(window, 'statechange', function(){
		var State = History.getState();
		var pageType = State.title;

		$.get(State.url, function(data) {	// Use AJAX to get the new content.
			document.title = data.match(/<title>(.*?)<\/title>/)[1];
			var d = $(data).filter('.content');
...
// var partnershipQuoteSlash = function() {
//
//   var slash = "<div class=""></div>"
//   $(this).append(slash);
// }
//
// $(document).ready(function(){
//
//   $('.partnershipQuote-left').each(function() {
//     partnershipQuoteSlash(this);
//   });
//
// });
